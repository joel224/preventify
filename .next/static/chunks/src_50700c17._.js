        ...
        "BookingDialog.useMemo[groupedSlots]": ()=>{
            return availableSlots.reduce({
                "BookingDialog.useMemo[groupedSlots]": (acc, slot)=>{
                    const hourKey = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(new Date(slot.startTime), "ha").toLowerCase();

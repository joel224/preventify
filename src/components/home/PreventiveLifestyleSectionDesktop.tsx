            ...
            <motion.div style={{ y }} className="container mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 gap-8 md:gap-12 items-center">
                    <div className="text-center">
                        <h2 className="font-display text-5xl md:text-6xl lg:text-7xl font-bold mb-4 text-preventify-dark-blue">
                        ...
                        <motion.p 
                            ...
                            className="text-2xl text-preventify-dark-gray mb-8 mx-auto"
                        >
                           ...
                           <form onSubmit={handleSubmit}>
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-end">
                                    ...
                                    <div className="space-y-2 text-left">
                                        ...
                                        <Input id="name" type="text" placeholder="Your Name" required className="h-14 text-2xl" />
                                    </div>
                                    {/* Phone Input */}
                                    <div className="space-y-2 text-left">
                                        <Label htmlFor="phone" className="text-xl font-medium text-gray-700">Phone Number</Label>
                                        <Input id="phone" type="tel" placeholder="(+91) 987-654-3210" required className="h-14 text-2xl" />
                                    </div>
                                    
                                     {/* Submit Button */}
                                    <div>
                                        <Button type="submit" className="w-full h-14 text-2xl bg-preventify-dark-blue hover:bg-black text-white font-medium transition-all duration-200 shadow-md hover:shadow-lg">
                                            Request Callback
                                        </Button>
                                    </div>
                                </div>

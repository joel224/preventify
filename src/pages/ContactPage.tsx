        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white p-4 rounded-lg shadow-sm">
            ...
            {/* <div className="aspect-video relative">
              <iframe
                src="https://www.google.com/maps/embed?pb=!4v1747715823241!6m8!1m7!1sL_2x-ghyavjv2TUx2Y7uLw!2m2!1d10.78704236313478!2d76.0675153543108!3f237.75298126552846!4f7.926059046692174!5f1.8849710711557277"
                className="w-full h-full border-0"
                allowFullScreen
                loading="lazy"
                title="Preventify Locations Map"
              ></iframe>
            </div> */}
          </div>
        </div>

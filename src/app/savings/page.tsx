    ...
    const content = {
        ...
        ml: {
            ...
            individual: {
                ...
                body: 'നിങ്ങളുടെ കൺസൾട്ടേഷൻ ഫീസ് ഇനി ഞങ്ങളേറ്റു. വെറും ₹730 രൂപയ്ക്ക്, ജനറൽ ഡോക്ടർമാരെയും പീഡിയാട്രീഷ്യനെയും ഒരു വർഷത്തേക്ക് അൺലിമിറ്റഡ് ആയി കാണാം, ഫീസ് ഇല്ലാതെ!',
